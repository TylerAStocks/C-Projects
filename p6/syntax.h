...
/** Make an expression that compares two operands as either integers or Strings.
    Returns true if both operands individually evaluate to true.
    @param left first sub-expression we're dividing
    @param right second sub-expression we're dividing
    @return pointer to a new, dynamically allocated subclass of Expr
 */
...
/** Make an expression that compares two operands es either integers or Strings.
    Returns true if either operand evaluates to true individually.
    @param left first sub-expression we're dividing
    @param right second sub-expression we're dividing
    @return pointer to a new, dynamically allocated subclass of Expr
 */
